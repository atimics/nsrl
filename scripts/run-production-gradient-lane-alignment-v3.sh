...
trace="${NSRL_PRODUCTION_GRADIENT_ALIGNMENT_TRACE:-benchmarks/production-model-v1/p10m-gradient-lane-alignment-v3.json}"
...
echo "production p10m causal no-rescue gradient alignment audit completed: $trace"
