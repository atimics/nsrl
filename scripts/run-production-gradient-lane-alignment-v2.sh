...
trace="${NSRL_PRODUCTION_GRADIENT_ALIGNMENT_TRACE:-benchmarks/production-model-v1/p10m-gradient-lane-alignment-v2.json}"
...
echo "production p10m rescue-stratified gradient alignment audit completed: $trace"
