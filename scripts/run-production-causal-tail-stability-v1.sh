...
name="p10m-causal-tail-stability-v1"
...
export NSRL_VECTOR_LEARNING_RATE_SHIFT=14
export NSRL_FINAL_RMS_LEARNING_RATE_SHIFT=11
export NSRL_Q_LEARNING_RATE_SHIFT=23
export NSRL_K_LEARNING_RATE_SHIFT=25
export NSRL_V_LEARNING_RATE_SHIFT=27
export NSRL_O_LEARNING_RATE_SHIFT=16
export NSRL_UP_LEARNING_RATE_SHIFT=20
export NSRL_GATE_LEARNING_RATE_SHIFT=20
