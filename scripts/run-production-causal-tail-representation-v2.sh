...
name="p10m-causal-tail-representation-v2"
...
export NSRL_EMBEDDING_LEARNING_RATE_SHIFT=0
...
export NSRL_K_LEARNING_RATE_SHIFT=22
export NSRL_V_LEARNING_RATE_SHIFT=26
export NSRL_O_LEARNING_RATE_SHIFT=10
export NSRL_UP_LEARNING_RATE_SHIFT=59
export NSRL_GATE_LEARNING_RATE_SHIFT=59
export NSRL_DOWN_LEARNING_RATE_SHIFT=59
export NSRL_OUTPUT_LEARNING_RATE_SHIFT=51
