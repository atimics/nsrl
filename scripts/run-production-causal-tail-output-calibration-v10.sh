...
name="p10m-causal-tail-output-calibration-v10"
...
export NSRL_CAUSAL_SEQUENCE_SOURCE_MODEL="data/experiments/production-model-v1/p10m-causal-tail-representation-v9-health-scale/chunk-3/model.nsrlpm"
export NSRL_EMBEDDING_BOOST_SHIFT=0
export NSRL_MATRIX_LEARNING_RATE_SHIFT=59
export NSRL_EMBEDDING_LEARNING_RATE_SHIFT=59
export NSRL_VECTOR_LEARNING_RATE_SHIFT=62
export NSRL_FINAL_RMS_LEARNING_RATE_SHIFT=59
export NSRL_Q_LEARNING_RATE_SHIFT=59
export NSRL_K_LEARNING_RATE_SHIFT=59
export NSRL_V_LEARNING_RATE_SHIFT=59
export NSRL_O_LEARNING_RATE_SHIFT=59
export NSRL_UP_LEARNING_RATE_SHIFT=59
export NSRL_GATE_LEARNING_RATE_SHIFT=59
export NSRL_DOWN_LEARNING_RATE_SHIFT=59
export NSRL_OUTPUT_LEARNING_RATE_SHIFT=30
export NSRL_OUTPUT_BIAS_LEARNING_RATE_SHIFT=51
...
export NSRL_CAUSAL_SEQUENCE_REJECT_SATURATED_BATCH=1
...
target/release/nsrl-production-residual-saturation-audit \
  --manifest benchmarks/open-generation-v1/manifest.tsv \
  --tokenizer "$tokenizer" --model "$model" --trace "$saturation" >/dev/null
