...
DEFAULT_SIGIL_MODEL_PATH="$REPO_ROOT/data/processed/key-solomon-goetia-denoise-v1/text-multichannel-conv/model.nsrltch"
DEFAULT_SIGIL_TEXT_INDEX_PATH="$REPO_ROOT/data/processed/key-solomon-goetia-text-index-pg72679/solomon-spirit-text-signatures.tsv"
