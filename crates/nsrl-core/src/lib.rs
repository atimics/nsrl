...
pub use attention::{
    AttentionResidualWorkspace, LOGIT_FRAC_BITS, MASKED_LOGIT, PreNormAttentionResidualWorkspace,
    Q15_SHIFT, SelfAttentionI16Params, SelfAttentionWorkspace, attention_dot_q_k_i16_i32_checked,
    ...
    attention_weight_v_i16_q15_checked, base2_exp_neg_q15, base2_softmax_i32_q15, is_power_of_four,
...
pub use linear::{
    ...
    LinearKernel, LinearWeightUpdateStats,
...
pub use numeric::{
    ...
    round_shift_rhu_i64, saturate_i8, saturate_i16, saturating_add_i16,
};
pub use rms_norm::{
